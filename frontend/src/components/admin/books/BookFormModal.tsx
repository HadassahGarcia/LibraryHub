...
export function BookFormModal({ open, book, categories, onClose, onSubmit }: BookFormModalProps) {
  return (
    <AnimatePresence>
      {open && (
...
function Field({ label, name, defaultValue, required, serif, mono }: { label: string; name: string; defaultValue?: string; required?: boolean; serif?: boolean; mono?: boolean }) {
  return (
    <div className="space-y-2">
